...
| Long renders 1h/8h/12h | fable | Campfire 1h smoke rendered; QA failed geometry | fix 1280x720 -> 1920x1080 black-tail switch, rerender |
...
## Done (recent)
- Campfire 1h local smoke render completed; audio/visual samples pass except midstream geometry switch (2026-07-12)
